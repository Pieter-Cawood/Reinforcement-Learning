...
class MyAgent:
    def __init__(self, observation_space, action_space, **kwargs):
        ...
        param_path = path + '/netParams.pkl'
        state_path = path + '/netState.pkl'
        with open(param_path, 'rb') as f:
            in_s, out_s, lr, hl, hn = pickle.load(f)
        net = actorCriticNet(in_shape=in_s, out_shape=out_s, learning_rate=lr, n_hidden_layers=hl, n_hidden_nodes=hn)
